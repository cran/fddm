...
#                             W = W, SV = SV, err_tol = err_tol,
#                             times = 100, unit = "ns")
#  save(bm_vec, file = "inst/extdata/bm_vec.Rds", compress = "xz")
...
#                             W = W, SV = SV, err_tol = err_tol,
#                             times = 100, unit = "ns")
#  save(bm_ind, file = "inst/extdata/bm_ind.Rds", compress = "xz")
...
ma <- max(fit_mbm[fit_mbm$Algorithm != "fs_SWSE_17", "BmTime"]) # weird point
