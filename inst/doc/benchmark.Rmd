...
The first plot will show the densities of the `microbenchmark` timings for each method. Note that we have zoomed in and have removed one outlier time from the "fs_SWSE_17" method which takes around 330 milliseconds to finish and did not converge successfully on the maximum-likelihood estimate.
